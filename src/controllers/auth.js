...
import { getOneUser } from '../repository/user.js';
import {
  authLogin,
  authRegister,
...
import { sendRefreshTokenResponse, sendTokenResponse } from '../utils/jwt.js';
...
export const logout = (req, res) => {
  ...
  return makeResponse({ res, message: 'Logout successful' });
};
